function populateRolesTable(userRoles) {
...
// Wait for authentication to complete before running
async function waitForAuthentication() {
  while (typeof userRoles === "undefined") {
    await new Promise(resolve => setTimeout(resolve, 100)); // Wait for 100ms
  }
  populateRolesTable(userRoles);
}
